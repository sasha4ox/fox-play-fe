...
/** Request payout in crypto (USDT TRC20). body: { amount, currency, walletAddress } — `amount` is total USD debited from balance (gross), minimum 10; fee is 3% of gross + $1 (rounded up to cents); the rest is sent to the wallet. Optional totpCode for 2FA. */
