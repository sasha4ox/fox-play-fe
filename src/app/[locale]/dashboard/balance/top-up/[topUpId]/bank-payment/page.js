...
export default function BalanceTopUpBankPaymentPage() {
  ...
  const isSepa = data?.bankTransferKind === 'sepa';

  return (
    <Container maxWidth={{ xs: 'sm', md: 'md' }} sx={{ py: 4 }}>
      <Typography variant="h5" fontWeight={600} gutterBottom>
        {isSepa ? t('titleSepa') : t('title')}
      </Typography>
      <Typography variant="body2" color="text.secondary" sx={{ mb: 3 }}>
        {isSepa ? t('instructionSepa') : t('instruction')}
      </Typography>
      ...
      {showCredentials && (
        ...
        >
          <Typography variant="subtitle2" fontWeight={600} gutterBottom>
            {isSepa ? t('credentialsTitleSepa') : t('credentialsTitle')}
          </Typography>
